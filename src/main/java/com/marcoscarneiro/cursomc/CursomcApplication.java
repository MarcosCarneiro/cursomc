package com.marcoscarneiro.cursomc;

import com.marcoscarneiro.cursomc.domain.*;
import com.marcoscarneiro.cursomc.domain.enums.EstadoPagamento;
import com.marcoscarneiro.cursomc.domain.enums.TipoCliente;
import com.marcoscarneiro.cursomc.repositories.*;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... strings) throws Exception {
		...
		Produto p7 = new Produto(null, "TV true color", 1_200.00);
		...
		ItemPedido ip1 = new ItemPedido(p1, ped1, 0.00, 1, 2_000.00);
